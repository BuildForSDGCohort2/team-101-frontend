    ...
    return(
        <section className="mt-5">
            <div className="input-group ">
                <input className="form-control py-4" type="search" placeholder="Search 10,000+ datasets" id="search-input"/>
    ...
    return(
        <li className="list-group-item pb-0 px-0">
                        <nav className="nav nav-pills nav-fill h4 nav-scrolspy">
                            <a className="nav-item nav-link actived pb-2" href="#collapseOne" role="button" data-toggle="collapse" >
                                <i className="fas fa-database pr-3"></i>Public
                            </a>
                            <a className="nav-item nav-link  pb-2" data-toggle="collapse" href="#collapseTwo" role="button">
                                <i className="fas fa-download pr-3"></i>Download
                            </a>
                            <a className="nav-item nav-link pb-2" data-toggle="collapse" href="#collapseThree" role="button">
                                <i className="far fa-heart pr-3"></i>Favorite
                            </a>
                            <div className="d-flex align-items-center pr-2 mb-1">
                                <h4 className="mb-0 fonwel">Sort by:
                                </h4>
                                <select name="choice" className="border-0 pl-2 font-weight-bold">
                                    <option value="first" selected>Trending</option> 
...
function PublicContente() {
    return(
        <div id="collapseOne" className="collapse show" data-parent="#accordion">
                            ...
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    ...
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> Samuel001</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li className="list-group-item">
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    ...
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> Simon_Paul</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    ...
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> databank</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    ...
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> Olusanya102</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    <h5>Kwik delivery  </h5>
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> Queendata</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    ...
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> King_dos</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    ...
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> Pythongod</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                ...
                                <div className="col-11 d-flex flex-column justify-content-center">
                                    ...
                                    <div className="d-flex">
                                        <div className="pr-3"> <i className="far fa-user pr-1"></i> Lagos_safety</div>
                                        <div className="pr-3"> <i className="fas fa-download pr-1"></i>Download</div>
                                        <div className="pr-3"> <i className="far fa-heart pr-1"></i>Favourite</div>
                                    </div>
                                </div>
                        ...
                        <button type="button" className="btn-next">Next page <i className="far fa-arrow-alt-circle-right pl-2"></i> </button>
                    </div>
    )
}
